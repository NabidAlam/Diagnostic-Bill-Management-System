        ...
        <div class="col-md-9 row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox CssClass="form-control" ID="txtFeeOfTest" runat="server" ReadOnly="True"></asp:TextBox>
                </div>
            ...
            <div class="col-md-5 col-md-offset-1">
                ...
                <span>Total</span>
                <asp:TextBox ID="txtTotalTestAmount" runat="server" CssClass="form-control pull-right" ReadOnly="True"></asp:TextBox>
                <br />
                <br />
                <br />
